...
init([]) ->
    ...
    Scenario = {{scenario,?NODE1}, 
		...
		worker,
		[sim_part]},
    CruiseCtl = {{cruisectl,?NODE1}, 
		{sim_part, start_link,[cruisectl,?NODE1,cruisectl, start, []]},
		permanent,
		brutal_kill,
		worker,
		[sim_part]},
    {ok,{{one_for_one,1,10},
	 [Scenario,Transmission,Balancectl,Sim_db,Loadenv,Dcs,Output, WheelFright,WheelRright,WheelFleft,WheelRleft,Frsensor,Bksensor,Risensor,Lfsensor,Throttle,Brake,CruiseCtl]
	}}.
